const translations = {
  zh: {
    ...
    q11: '搜索插件会上传我的关键词吗？',
    a11: '不会。目录搜索、筛选和排序在浏览器本地完成。网站使用自托管 Umami 统计页面浏览和有限交互；国内站另保留百度统计。不会把站内搜索词、邮件地址或 Profile 内容作为统计事件发送。',
    q12: '遇到问题或希望合作，如何联系 DSH STORE？',
    a12: '可以发送邮件至 jadename.zhou@gmail.com，或通过 X 上的 @builtbyxm 联系。插件提交请优先使用 GitHub 提交表单。',
  ...
  en: {
    ...
    a11: 'No. Catalog search, filtering, and sorting run locally in your browser. The site uses self-hosted Umami for page views and limited interactions; the domestic site also keeps Baidu Analytics. Search terms, email addresses, and Profile contents are not sent as analytics events.',
    q12: 'How can I get help or discuss a partnership?',
    a12: 'Email jadename.zhou@gmail.com or contact @builtbyxm on X. For plugin submissions, use the GitHub submission form first.',
