const translations = {
  zh: {
    ...
    'a11y.skip': '跳到主要内容',
    'nav.home': '首页', 'nav.store': '插件目录', 'nav.community': '社区与开发者', 'nav.standards': '收录标准', 'nav.build': '开发插件', 'nav.faq': '常见问题', 'nav.about': '关于我们', 'nav.policy': '政策原文', 'nav.submit': '提交插件',
  ...
  en: {
    ...
    'nav.home': 'Home', 'nav.store': 'Plugin catalog', 'nav.community': 'Community & creators', 'nav.standards': 'Listing standards', 'nav.build': 'Build plugins', 'nav.faq': 'FAQ', 'nav.about': 'About us', 'nav.policy': 'Policy source', 'nav.submit': 'Submit plugin',
