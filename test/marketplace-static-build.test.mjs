...
test('static marketplace derives manager identity and catalog cards without mutating the authority file', async () => {
  ...
  try {
    ...
    assert.match(home, /c0cf0ce3-b77c-4570-9573-59c07a583950/)
    assert.match(home, /https:\/\/aiaiai\.help\/umami\/script\.js/)
    assert.doesNotMatch(home, /763ad43e-f5c9-4342-9a82-8366d1ea90df/)
...
test('static marketplace accepts a domestic origin and renders the ICP record', async () => {
  ...
  try {
    ...
    for (const pagePath of pagePaths) {
      ...
      assert.equal((page.match(/763ad43e-f5c9-4342-9a82-8366d1ea90df/g) || []).length, 1)
      assert.match(page, /https:\/\/aiaiai\.help\/umami\/script\.js/)
      assert.doesNotMatch(page, /c0cf0ce3-b77c-4570-9573-59c07a583950/)
