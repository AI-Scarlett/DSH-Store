...
const entry = (id, rc8, updatedAt, overrides = {}) => ({
  id, name: id, status: 'approved', featured: false, installCount: 0, version: '1.0.0',
  compatibility: { dshReleases: { 'rc.8': rc8 } }, source: { updatedAt }, ...overrides,
})

test('trusted ranking is approved then rc.8 compatibility then source freshness', () => {
  const values = [
