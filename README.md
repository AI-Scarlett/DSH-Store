...
```bash
dsh plugin --profile web add 'git+https://github.com/AI-Scarlett/dsh-safe-plugin-manager.git#60579b9d6b935ca3a207c58e8f3a107b56a3f931'
```
...
| 远端 Catalog 证据兼容 `0.8.3` | [`60579b9`](https://github.com/AI-Scarlett/dsh-safe-plugin-manager/commit/60579b9d6b935ca3a207c58e8f3a107b56a3f931) | 接受受契约约束的 `partial` 证据状态，避免可验证的远端目录被旧客户端误判为无效后只能使用内置快照。 |
