...
| 插件详情与更新修复 `0.4.0` | [`3acd578`](https://github.com/AI-Scarlett/dsh-safe-plugin-manager/commit/3acd578) | 补齐 31 个插件的权限、许可证、审核与兼容性详情；为商城不可安装项目提供 GitHub 手动入口，并修复 DSH 运行环境中的 pnpm PATH。 |
