...
- DeepSeek Harness `0.1.0-rc.8` 或更高版本，并且官方 `dsh` CLI 可用；
...
```bash
dsh plugin --profile web add 'git+https://github.com/AI-Scarlett/dsh-safe-plugin-manager.git#6b6453eec1c1b83f7cdf48d03f7a54f85d83c562'
```
...
- DSH `0.1.0-rc.8` 中使用紧凑的响应式卡片、状态圆点、清晰的操作区和无障碍列表语义；
...
- 在一次性 DSH `0.1.0-rc.8` Profile 中使用官方 CLI 验证安装、配置合成和功能可见性；
